    ...
    <div className="flex items-center justify-center h-screen bg-gray-100">
      <div className="flex items-center space-x-1 bg-white rounded-full shadow-md p-1">
        <button
          ...
          className="w-10 h-10 flex items-center justify-center bg-gray-200 rounded-full text-gray-600 focus:outline-none focus:ring-gray-400"
          aria-label="Decrement"
        >
          -
        </button>
        <div className="w-14 h-8 relative overflow-hidden">
    ...
    <div className="relative w-[10px] h-full">
      <AnimatePresence mode="popLayout" custom={direction}>
        <motion.span
          ...
          className="absolute inset-0 flex items-center justify-center text-2xl font-sfpro tracking-widest font-semibold"
        >
          {digit}
        </motion.span>
      </AnimatePresence>
